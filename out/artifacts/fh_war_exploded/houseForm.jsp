    ...
    <ul class="form-section page-section">
        ...
        <li class="form-line jf-required" data-type="control_textbox" id="id_1">
            ...
            <div id="cid_1" class="form-input-wide jf-required">
                <input type="text" id="input_1" name="name" data-type="input-textbox"
                       class="form-textbox validate[required]" size="48" value="" placeholder=" "
                        ...
                        <td colspan="2">
                          <span class="form-sub-label-container" style="vertical-align:top;">
                            <input type="text" id="input_20_addr_line1" name="street"
                                   class="form-textbox form-address-line" value="" data-component="address_line_1"/>
        ...
        <li class="form-line" data-type="control_textarea" >
            ...
            <div class="form-input-wide">
                <textarea  class="form-textarea" name="description" cols="40" rows="6" data-component="textarea"></textarea>
            </div>
        </li>
        ...
        <li class="form-line" data-type="control_textarea" >
            ...
            <div class="form-input-wide">
                <textarea  class="form-textarea" name="space" cols="40" rows="6" data-component="textarea"></textarea>
            </div>
        </li>
        ...
        <li class="form-line" data-type="control_textarea" >
            ...
            <div class="form-input-wide">
                <textarea  class="form-textarea" name="notes" cols="40" rows="6" data-component="textarea"></textarea>
            </div>
        </li>
        ...
        <li class="form-line" data-type="control_textarea" >
            ...
            <div class="form-input-wide">
                <textarea  class="form-textarea" name="transit" cols="40" rows="6" data-component="textarea"></textarea>
            </div>
        </li>
        ...
        <li class="form-line" data-type="control_textarea" >
            ...
            <div class="form-input-wide">
                <textarea  class="form-textarea" name="xx" cols="40" rows="6" data-component="textarea"></textarea>
            </div>
        </li>
        ...
        <li class="form-line" data-type="control_textarea" >
            ...
            <div class="form-input-wide">
                <textarea  class="form-textarea" name="access" cols="40" rows="6" data-component="textarea"></textarea>
            </div>
        </li>
        ...
        <li class="form-line" data-type="control_textarea" >
            ...
            <div class="form-input-wide">
                <textarea  class="form-textarea" name="interaction" cols="40" rows="6" data-component="textarea"></textarea>
            </div>
        </li>
        ...
        <li class="form-line" data-type="control_textarea" >
            ...
            <div class="form-input-wide">
                <textarea  class="form-textarea" name="house_rules" cols="40" rows="6" data-component="textarea"></textarea>
            </div>
        </li>
        ...
        <li class="form-line jf-required" data-type="control_textbox" >
            ...
            <div class="form-input-wide jf-required">
                <input type="text"  name="property_type" data-type="input-textbox" class="form-textbox" size="48" value="" data-component="textbox" />
            </div>
        </li>
            ...
            <div  class="form-input-wide">
                <div class="form-single-column" data-component="radio">
                    <span class="form-radio-item" style="clear:left;">
                      ...
                      <input type="radio" class="form-radio" name="q10_haveYou10" value="0"/>
                      <label  > Private room </label>
                    </span>
                      <span class="form-radio-item" style="clear:left;">
                      <span class="dragger-item">
                      </span>
                      <input type="radio" class="form-radio" name="q10_haveYou10" value="1"/>
                      <label > Entire Room </label>
                    </span>
                    <span class="form-radio-item" style="clear:left;">
                      <span class="dragger-item">
                      </span>
                      <input type="radio" class="form-radio" name="q10_haveYou10" value="2"/>
        ...
        <div id="cid_21" class="form-input jf-required">
            ...
            <span class="form-sub-label-container" style="vertical-align:top;">
              ...
              <input type="number"  class="form-textbox" size="3" value=""  name ="bedrooms" />
            </span>
                <span class="form-sub-label-container" style="vertical-align:top;">
              <label class="form-sub-label"  style="min-height:13px;" name="bathrooms"> Bathroom Number: </label>
              <input type="number"  class="form-textbox" size="3" value="" name="bathrooms" />
            </span>
                <span class="form-sub-label-container" style="vertical-align:top;">
              <label class="form-sub-label"   style="min-height:13px;" > Bed Number:</label>
              <input type="number"  class="form-textbox" size="3" value="" name="beds" />
            </span>
            </div>
        </div>
        </li>
        ...
        <li class="form-line jf-required" data-type="control_phone" id="id_21">
            ...
            <span class="form-sub-label-container" style="vertical-align:top;">
              ...
              <input type="number"  class="form-textbox" size="3" value=""  required="" name ="guests_includes" />
            </span>
                    <span class="form-sub-label-container" style="vertical-align:top;">
              <label class="form-sub-label"  style="min-height:13px;" > Price: </label>
              <input type="number"  class="form-textbox" size="3" value="" name="price"/>
            </span>
                    <span class="form-sub-label-container" style="vertical-align:top;">
