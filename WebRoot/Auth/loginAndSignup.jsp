...
<%if(null!=request.getParameter("type")) {
    ...
    if(type == 0){
        ...
        if(ac.signup(us)){%>
<h1> <%=us.getFirstName()+" " %> you successfully registerd please login! </h1>
        <%}
...
<div class="form">
    ...
    <div class="tab-content">
        <div id="signup">
            ...
            <form action="/Auth/loginAndSignup.jsp?type=0" method="post">
        ...
        <div id="login">
            ...
            <form action="/Auth/loginAndSignup.jsp?type=2" method="post">
